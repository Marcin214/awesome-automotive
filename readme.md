...
- [A TCP/IP Tutorial <img src="media/icons/student.png" height="18"/>](https://tools.ietf.org/html/rfc1180l) - RFC 1180, short overview on ethernet.
- [Automotive Grade Linux](http://opensig.org/about/specifications/) - fully open software stack for the connected car.
...
- [Bosch specification <img src="media/icons/pdf.png" height="18"/>](http://esd.cs.ucr.edu/webres/can20.pdf) -  superseded by the standard [ISO 11898](https://www.iso.org/standard/63648.html).
